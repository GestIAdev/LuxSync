...
export class ConsciousnessIntegration {
    patternHistory = [];
    sceneSuccessHistory = new Map();
    patternCounts = new Map();
    // Thresholds para epilepsia
    MAX_STROBE_FREQUENCY = 10; // Hz
    MAX_BRIGHTNESS = 0.95;
    /**
     ...
     */
    recallSuccessfulScenes(mood, minFitness = 0.7) {
        const successful = [];
    ...
    generateSuggestions(patternType, mood, energy) {
        const suggestions = [];
        switch (patternType) {
            case 'drop':
...
//# sourceMappingURL=ConsciousnessIntegration.js.map