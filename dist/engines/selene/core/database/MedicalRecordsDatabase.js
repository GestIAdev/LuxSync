...
export class MedicalRecordsDatabase extends BaseDatabase {
    ...
    async deleteMedicalRecord(id) {
        await this.pool.query(`UPDATE medical_records SET deleted_at = NOW(), updated_at = NOW() WHERE id = $1 AND deleted_at IS NULL`, [id]);
    }
    // ============================================================================
...
//# sourceMappingURL=MedicalRecordsDatabase.js.map