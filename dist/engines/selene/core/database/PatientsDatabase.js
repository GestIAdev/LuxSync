...
export class PatientsDatabase extends BaseDatabase {
    ...
    async getPatients(filters) {
        ...
        try {
            // Try cache first
            const cached = await this.safeRedisOperation(() => this.getRedis().get(cacheKey), null);
            if (cached) {
            ...
            await this.safeRedisOperation(() => this.getRedis().setEx(cacheKey, 300, JSON.stringify(graphqlPatients)), undefined);
    ...
    async getPatientById(id) {
        ...
        try {
            ...
            await this.safeRedisOperation(() => this.getRedis().setEx(cacheKey, 600, JSON.stringify(patient)), undefined);
            return patient;
        }
        catch (error) {
...
//# sourceMappingURL=PatientsDatabase.js.map