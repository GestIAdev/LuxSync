...
export class PatternSanityChecker {
    static MAX_FIBONACCI_VALUE = 1000000;
    static MIN_FIBONACCI_VALUE = -1000000;
    static MAX_RATIO_CHANGE = 5.0;
    static MIN_RATIO_CHANGE = 0.2;
    /**
     * Verifica cordura de patrón evolutivo
     */
    static checkPatternSanity(pattern) {
        const issues = [];
     ...
     */
    static checkFibonacciValues(sequence) {
        const issues = [];
     ...
     */
    static checkFibonacciRatios(sequence) {
        const issues = [];
     ...
     */
    static checkZodiacPosition(position) {
        const issues = [];
     ...
     */
    static checkHarmonyRatio(ratio) {
        const issues = [];
     ...
     */
    static determineSeverity(issues) {
     ...
     */
    static checkPatternBatch(patterns) {
        return patterns.map(pattern => this.checkPatternSanity(pattern));
    }
}
//# sourceMappingURL=pattern-sanity-checker.js.map