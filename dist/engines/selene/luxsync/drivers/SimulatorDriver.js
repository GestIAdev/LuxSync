...
export class SimulatorDriver {
    ...
    render() {
        ...
        for (const fixture of this.fixtures) {
            ...
            if (isNaN(fixture.currentColor.r))
                fixture.currentColor.r = 0;
            if (isNaN(fixture.currentColor.g))
                fixture.currentColor.g = 0;
            if (isNaN(fixture.currentColor.b))
                fixture.currentColor.b = 0;
            if (isNaN(fixture.currentDimmer))
            ...
            const gradient = ctx.createRadialGradient(fixture.x, fixture.y, 0, fixture.x, fixture.y, this.config.fixtureSize * 1.5);
            ...
            if (this.config.showLabels) {
                ...
                ctx.fillStyle = '#aaa';
                ctx.fillText(`${fixture.definition.universe}.${fixture.definition.startChannel}`, fixture.x, fixture.y + 20);
            }
        }
        // Draw stats panel
...
//# sourceMappingURL=SimulatorDriver.js.map