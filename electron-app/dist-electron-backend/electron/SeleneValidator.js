...
function getVibePresetForTest(vibeId) {
    return VIBE_PRESETS[vibeId] || VIBE_PRESETS['techno-club'];
}
function simulateScenario(vibeId, rawBass, pulse, normMid, normTreble = 0) {
...
// 🧪 TEST RUNNER
// ─────────────────────────────────────────────────────────────────────────────
export function runSeleneDiagnostics() {
    const results = [];
    let passed = 0;
    let failed = 0;
    results.push('');
    ...
    for (const test of testCases) {
        const result = simulateScenario(test.vibeId, test.rawBass, test.pulse, test.normMid, test.normTreble);
...
// ─────────────────────────────────────────────────────────────────────────────
export { VIBE_PRESETS, simulateScenario };
