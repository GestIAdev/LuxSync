...
export { scoreHardware, shouldShowLauncher, isPerformanceTier, coercePerformanceTier, createDefaultPerformanceProfile, PERFORMANCE_TIERS, FORCE_LAUNCHER_FLAG, } from '../../src/core/config/performanceTiers';
// ═══════════════════════════════════════════════════════════════════════════════
// GPU FEATURE KEYS
// ═══════════════════════════════════════════════════════════════════════════════
/**
 ...
 */
function isHardwareAccelerated(status) {
...
export function probeHardware() {
    ...
    console.log(`[Vanguard] Hardware probe: ${profile.cpuCores} cores, ${profile.totalMemoryGB} GB, ` +
