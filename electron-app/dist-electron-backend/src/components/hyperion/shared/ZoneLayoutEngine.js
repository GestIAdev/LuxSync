 ...
 */
import { normalizeZone, CANONICAL_ZONES, ZONE_LABELS } from '../../../core/stage/ShowFileV2';
// ═══════════════════════════════════════════════════════════════════════════
 ...
 */
export function resolveFixtureZone(zone) {
 ...
 */
export function distributeInRange(index, total, min, max) {
    if (total <= 1)
        return (min + max) / 2;
 ...
 */
export function groupByCanonicalZone(fixtures) {
 ...
 */
export function calculatePosition2D(zone, index, totalInZone, canvasWidth, canvasHeight, fixtureType) {
 ...
 */
export function getDefaultPitch(zone) {
 ...
 */
export function isVerticalZone(zone) {
 ...
 */
export function hasStereoSplit(zone) {
