 ...
 */
export function hitTestFixtures(mouseX, mouseY, fixtures, canvasWidth, canvasHeight, baseRadius) {
    const hitRadius = Math.max(baseRadius * HIT_TEST_CONFIG.HIT_RADIUS_MULTIPLIER, HIT_TEST_CONFIG.MIN_HIT_RADIUS);
 ...
 */
export function hitTestLasso(bounds, fixtures) {
 ...
 */
export function getCanvasMousePosition(event, canvas, dpr = 1) {
