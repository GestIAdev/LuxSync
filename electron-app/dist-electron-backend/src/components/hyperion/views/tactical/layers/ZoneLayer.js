 ...
 */
import { ZONE_COLORS, ZONE_LAYOUT_2D, ZONE_LABELS, CANONICAL_ZONES } from '../../../shared/ZoneLayoutEngine';
 ...
 */
export function renderZoneLayer(ctx, width, height, options) {
    const { zones = CANONICAL_ZONES.filter(z => z !== 'unassigned'), showCounts = false, zoneCounts = new Map(), opacity = 1.0, } = options ?? {};
