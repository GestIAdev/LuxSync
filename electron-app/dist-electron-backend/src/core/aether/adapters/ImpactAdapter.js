 ...
 */
export class ImpactAdapter extends BaseSystem {
    constructor(engine, maxRadiusM = DEFAULT_MAX_RADIUS_M) {
        super();
        this.name = 'ImpactAdapter';
    ...
    // HOT-PATH — 44Hz
    // ─────────────────────────────────────────────────────────────────────────
    process(nodes, context, bus, liquidResult) {
        ...
        const result = liquidResult ?? this._engine.applyBands(inp);
