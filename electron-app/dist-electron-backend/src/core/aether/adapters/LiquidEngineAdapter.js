 ...
 */
export class LiquidImpactAdapter extends BaseSystem {
    constructor(engine, maxRadiusM = DEFAULT_MAX_RADIUS_M) {
        super();
        this.name = 'LiquidImpactAdapter';
        this.family = NodeFamily.IMPACT;
        this.source = IMPACT_SOURCE;
        /**
    ...
    process(nodes, context, bus) {
        ...
        const result = this._engine.applyBands(inp);
 ...
 */
export class LiquidColorAdapter extends BaseSystem {
    constructor(engine, maxRadiusM = DEFAULT_MAX_RADIUS_M) {
        super();
        this.name = 'LiquidColorAdapter';
 ...
 */
function selectZoneIntensity(result, nodeX, nodeY) {
