...
const FOG_MAX_CONTINUOUS_MS = 180000;
...
// ─────────────────────────────────────────────────────────────────────────────
export class AtmosphereCueDriver extends BaseSystem {
    constructor() {
        super();
        this.name = 'AtmosphereCueDriver';
        this.family = NodeFamily.ATMOSPHERE;
        this.source = CUE_SOURCE;
        ...
        this._cachedPump = new Map();
        this._cachedDensity = new Map();
        this._cachedFan = new Map();
        ...
        this._emissionArmed = new Map();
        this._fireValveTarget = new Map();
        this._ignitePulseUntilMs = new Map();
        this._lastCueMs = new Map();
     ...
     */
    pulseIgnition(nodeId, durationMs = 250) {
        const now = Date.now();
    ...
    // ─────────────────────────────────────────────────────────────────────────
    _recomputeFluid(node, atmosType, context) {
        const nodeId = node.nodeId;
