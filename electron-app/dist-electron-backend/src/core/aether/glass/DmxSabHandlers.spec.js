...
import { DMX_SAB_BYTES, DMX_HEADER_BYTES, MAX_UNIVERSES, CHANNELS_PER_UNI, } from './layout';
import { DmxUniverseWriter, DmxUniverseReader, createDmxSab, } from './DmxSabHandlers';
// ═══════════════════════════════════════════════════════════════════════════
...
describe('DmxUniverseWriter + DmxUniverseReader — hot-path básico', () => {
    ...
    it('los datos del universo 49 se ubican en el offset correcto', () => {
        const universes = new Array(MAX_UNIVERSES).fill(undefined);
    ...
    it('peekHeader devuelve maskLo y maskHi correctos', () => {
        ...
        const universes = new Array(3).fill(undefined);
        universes[0] = u0;
        universes[2] = u2;
