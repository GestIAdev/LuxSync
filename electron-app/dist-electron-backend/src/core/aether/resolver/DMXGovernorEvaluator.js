 ...
 */
export function buildGovernorLookupMap(governors) {
    const map = new Array(512).fill(undefined);
 ...
 */
export function applyDMXGovernors(govMap, channelOffset, channelType, normalized, computedByte) {
