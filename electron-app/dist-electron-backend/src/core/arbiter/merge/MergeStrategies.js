 ...
 * @version WAVE 373
 */
import { ControlLayer, DEFAULT_MERGE_STRATEGIES, } from '../types';
// ═══════════════════════════════════════════════════════════════════════════
 ...
 */
export function mergeHTP(values) {
    if (values.length === 0)
        return 0;
 ...
 * ]) // Returns 150
 */
export function mergeLTP(values) {
    if (values.length === 0)
        return undefined;
 ...
 */
export function mergeBLEND(values) {
    if (values.length === 0)
        return 0;
 ...
 */
export function mergeOVERRIDE(overrideValue) {
 ...
 */
export function mergeChannel(channelType, values, strategyOverride) {
    if (values.length === 0) {
 ...
 */
export function dmxToNormalized(value) {
    return value / 255;
}
/**
 * Convert a normalized value (0-1) to DMX range (0-255)
 */
export function normalizedToDMX(value) {
