...
function buildPolyphaseTable(inputRate, outputRate) {
    ...
    const coefficients = new Array(L);
...
export class PolyphaseResampler {
    constructor(inputRate, outputRate) {
        this.historyIndex = 0;
        this.inputPhase = 0; // Current position in L/M ratio
        ...
        this.latencySamples = Math.floor((this.table.tapsPerPhase * this.table.L) / (2 * this.table.M));
    }
    /**
 ...
 */
export function getResampler(inputRate, outputRate) {
