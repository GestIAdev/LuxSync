 ...
 */
function mapSectionType(section) {
    if (section === 'unknown')
        return 'intro';
    return section;
}
 ...
 */
export class SeleneBrainAdapter {
    constructor(config = {}) {
    ...
    applyAGC(rawEnergy, peakLevel) {
        ...
        this.agcPeakHold = Math.max(peakLevel, this.agcPeakHold * peakDecay);
