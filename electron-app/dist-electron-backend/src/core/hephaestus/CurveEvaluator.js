...
export class CurveEvaluator {
     ...
     */
    _quantizeIfStepped(curve, value) {
        if (curve.curveMode !== 'stepped')
            return value;
    ...
    getColorValue(paramId, timeMs) {
        ...
        const isValidHSL = (v) => v && typeof v === 'object' &&
     ...
     */
    interpolateNumber(v0, v1, progress, interpolation, handles) {
     ...
     */
    applyInterpolation(t, interpolation, handles) {
     ...
     */
    cubicBezierY(t, cx1, cy1, cx2, cy2) {
