    ...
    rules: [
        {
            ...
            check: (context, effect) => {
                ...
                if (last20.length < 10)
                    return { passed: true }; // Poco historial
    ...
    rules: [
        ...
        },
        {
            ...
            check: (context, effect) => {
                ...
                const recentInWindow = context.recentEffects.filter(e => Date.now() - e.timestamp < TEN_SECONDS_MS);
    ...
    rules: [
        ...
        },
        {
            ...
            check: (context, effect) => {
                ...
                const neglectedBias = context.biasReport?.biases.find(b => b.type === 'effect_neglect' && b.description.includes(effect.effect));
                if (neglectedBias) {
                    return {
                        passed: true,
                        boost: 0.1,
...
// EXPORT ALL VALUES
// ═══════════════════════════════════════════════════════════════
export const VISUAL_ETHICAL_VALUES = [
    AUDIENCE_SAFETY,
    VIBE_COHERENCE,
    EFFECT_DIVERSITY,
    AESTHETIC_BEAUTY,
...
// ═══════════════════════════════════════════════════════════════
export function logEthicalValues() {
