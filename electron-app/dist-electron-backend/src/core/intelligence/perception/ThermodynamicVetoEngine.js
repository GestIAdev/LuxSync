    ...
    validate(proposedSection, evidence, zone) {
        ...
        if (proposed === 'buildup') {
            if (ev.energyDelta > 0.02 && ev.zTotal > -0.5) {
                ...
                if (ev.eTotal > 0.65) {
                    return this.accept(proposed, 'climax', ev, `Buildup overridden to climax: sustained E=${ev.eTotal.toFixed(2)} despite rising ΔE`);
                }
            ...
            if (ev.eTotal > 0.65) {
                return this.accept(proposed, 'climax', ev, `Buildup overridden to climax: sustained E=${ev.eTotal.toFixed(2)} with stable ΔE`);
            }
            return {
