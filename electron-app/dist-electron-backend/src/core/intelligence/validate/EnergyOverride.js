 ...
 * @version 500.0.0
 */
import { ENERGY_OVERRIDE_THRESHOLD, } from '../types';
// ═══════════════════════════════════════════════════════════════════════════
// CONSTANTES
// ═══════════════════════════════════════════════════════════════════════════
/**
 ...
 * ```
 */
export function applyEnergyOverride(state) {
    // Check umbral
 ...
 */
export function getEnergyOverrideInfo(state) {
 ...
 */
export function getEnergyDistanceToThreshold(state) {
 ...
 */
export function predictEnergyOverride(state) {
