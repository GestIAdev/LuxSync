...
function isValidLoadout(obj) {
    ...
    return (typeof o['id'] === 'string'
        ...
        && SUPPORTED_VERSIONS.has(o['version'])
 ...
 */
export function setupKeyForgeIPCHandlers(getMainWindow) {
    // ─────────────────────────────────────────────────────────────────────────
    // lux:keyforge:export
    ...
    // ─────────────────────────────────────────────────────────────────────────
    ipcMain.handle('lux:keyforge:export', async (_event, loadout) => {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    ipcMain.handle('lux:keyforge:import', async (_event) => {
