...
function hydrateBackendFromShow(showFile) {
    try {
 ...
 */
export function setupStageIPCHandlers(getMainWindow) {
    // ═══════════════════════════════════════════════════════════════════════
    // LOAD
    // ═══════════════════════════════════════════════════════════════════════
    /**
     ...
     */
    ipcMain.handle('lux:stage:load', async (_event, filePath) => {
     ...
     */
    ipcMain.handle('lux:stage:save', async (_event, showFile, filePath) => {
     ...
     */
    ipcMain.handle('lux:stage:saveAs', async (_event, showFile, name) => {
     ...
     */
    ipcMain.handle('lux:stage:delete', async (_event, filePath) => {
     ...
     */
    ipcMain.handle('lux:stage:exists', async (_event, name) => {
     ...
     */
    ipcMain.handle('lux:stage:saveAsDialog', async (_event, showFile, suggestedName) => {
     ...
     */
    ipcMain.handle('lux:stage:confirmUnsaved', async (_event, showName) => {
        const mainWindow = getMainWindow();
