 ...
 */
export const SEALED_PARAMS_INFO = [
    // ── SEGURIDAD DE HARDWARE (8) ──────────────────────────────────────────
    {
        ...
        reason: 'Límite absoluto de aceleración (DMX/s²). Superarlo desgarra las correas ' +
    ...
    },
    {
        ...
        owner: 'engine/movement/FixturePhysicsDriver.ts',
        category: 'hardware-safety',
        reason: 'Límite absoluto de velocidad (DMX/s ≈ 850°/s). Superarlo hace que los ' +
    ...
    },
    {
        ...
        category: 'hardware-safety',
        reason: 'Techo del tilt. Impide que el haz apunte al techo (luz perdida) y que ' +
    ...
    },
    {
        ...
        owner: 'engine/movement/VibeMovementManager.ts',
        category: 'hardware-safety',
        reason: 'Suelo del tilt (máx 67° desde la vertical). Impide que el haz cruce al ' +
    ...
    },
    {
        ...
        owner: 'engine/movement/VibeMovementManager.ts',
        category: 'hardware-safety',
        reason: 'Offset de tilt para montaje ceiling/truss. Centra la onda en la ' +
    ...
    },
    {
        ...
        category: 'hardware-safety',
        reason: 'Margen en unidades DMX que garantiza que el fixture nunca golpee sus ' +
    ...
    },
    {
        ...
        owner: 'engine/movement/VibeMovementManager.ts',
        category: 'hardware-safety',
        reason: 'Suelo del Gearbox. Evita la división degenerada que produciría amplitud ' +
    ...
    },
    {
        ...
        category: 'hardware-safety',
        reason: 'Duración de la rampa de recuperación post-AGC. Es una constante de ' +
    ...
    // ── SEGURIDAD HUMANA (2) ───────────────────────────────────────────────
    {
        ...
        reason: 'Techo anti-epilepsia. El rango 15-25 Hz es el de mayor riesgo ' +
    ...
    },
    {
        ...
        owner: 'engine/movement/VibeMovementManager.ts',
        category: 'human-safety',
        reason: 'Rango del breathing amplifier. Por debajo de 0.85 los patrones pierden ' +
    ...
    // ── INTEGRIDAD MATEMÁTICA (9) ──────────────────────────────────────────
    {
        ...
        reason: 'Zona de singularidad blindada (50 mm). Por debajo, atan2 es ' +
    ...
    },
    {
        ...
        category: 'math-integrity',
        reason: 'Alpha del EMA lento (0.98/0.02) del gate adaptativo. Hardcodeado: el ' +
    ...
    },
    {
        ...
        owner: 'hal/physics/LiquidEnvelope.ts',
        category: 'math-integrity',
        reason: 'Alpha del EMA rápido (0.88/0.12). Idem: afecta el tracking del gate ' +
    ...
    },
    {
        ...
        owner: 'hal/physics/LiquidEnvelope.ts',
        category: 'math-integrity',
        reason: 'Los 3 factores de decay del peak tracker. Definen el gate adaptativo; ' +
    ...
    },
    {
        ...
        owner: 'hal/physics/LiquidEngineBase.ts',
        category: 'math-integrity',
        reason: 'Cooldown de la detección de kick. Constante de hardware: por debajo se ' +
    ...
    },
    {
        ...
        owner: 'hal/physics/LiquidEngineBase.ts',
        category: 'math-integrity',
        reason: 'Zona de fade cuadrático anti-guillotine. Evita el corte abrupto ' +
    ...
    },
    {
        ...
        category: 'math-integrity',
        reason: 'Mapeo sinestésico canónico nota → hue. Es la identidad cromática de ' +
 ...
 */
export const SEALED_PARAMS = new Set(SEALED_PARAMS_INFO.map((p) => p.path));
/**
 ...
 */
export function isSealed(path) {
    if (SEALED_PARAMS.has(path))
        return true;
 ...
 */
export function getSealInfo(path) {
