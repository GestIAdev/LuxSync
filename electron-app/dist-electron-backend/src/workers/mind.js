...
import { createDefaultMusicalContext, deriveSpectralTexture, } from '../core/protocol/MusicalContext';
// ============================================
// CONFIGURATION
// ============================================
...
function extractMusicalContext(analysis) {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    const narrative = buildNarrativeContext(section, analysis.energy);
    return {
        key,
        mode,
        bpm: analysis.bpm,
 ...
 */
function buildSpectralContext(analysis) {
    ...
    const extendedAnalysis = analysis;
 ...
 */
function buildNarrativeContext(section, energy) {
