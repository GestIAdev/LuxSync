...
let _instance = null;
export function getEnergyNormalizer() {
    if (!_instance) {
...
export function resetEnergyNormalizer() {
    if (_instance) {
        _instance.reset();
    }
}
