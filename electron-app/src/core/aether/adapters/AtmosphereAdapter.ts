...
const COOLDOWN_SPARK_MS =  8_000
const COOLDOWN_PYRO_MS  = 30_000
 ...
 * WAVE 3516.4: THE ELEMENTAL BRIDGE
 */
export class AtmosphereAdapter extends BaseSystem<IAtmosphereNodeData> implements IAetherSystem<IAtmosphereNodeData> {

  readonly name   = 'AtmosphereAdapter'
  readonly family = NodeFamily.ATMOSPHERE
  readonly source: string = ATMOS_SOURCE
   ...
   */
  private _getCooldownMs(
    type: IAtmosphereNodeData['atmosType'],
  ): number {
    switch (type) {
