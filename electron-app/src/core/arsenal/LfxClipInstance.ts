...
export class LfxClipInstance {
  ...
  public toCognitiveDNA(overrides?: Partial<CognitiveDNA>): CognitiveDNA {
    ...
    const isHardAggressionArchetype =
    ...
    const computedAggressionRange = Object.freeze(
      isAmbientAggressionArchetype
        ...
        : isHardAggressionArchetype
          ...
          : { min: 0.0, max: 1.0 }, // utility — permissive
    )
    const aggressionRange = Object.freeze(
      overrides?.aggressionRange
