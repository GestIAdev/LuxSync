...
export class CognitiveFluidState {
  ...
  private _smoothedPhaseMod: number = 0.5  // EMA del phase modifier, arranca conservador
  ...
  constructor(
    private profile: ILiquidCognitionProfile,
  ) {
   ...
   */
  updateProfile(newProfile: ILiquidCognitionProfile): void {
