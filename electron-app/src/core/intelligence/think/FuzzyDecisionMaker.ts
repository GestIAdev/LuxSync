...
export interface FuzzyInputs {
  ...
  beauty: number
  /** 🩸 WAVE 6040: Penalización si no ha habido un valle de energía post-disparo */
...
export interface FuzzyEvaluatorInput {
  ...
  /** 🩸 WAVE 6040: Energía mínima desde el último efecto disparado (valley tracker) */
  minEnergySinceLastEffect?: number
}
