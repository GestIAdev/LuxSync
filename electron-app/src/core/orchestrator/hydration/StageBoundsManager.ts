...
import type { PhysicsPostProcessor } from '../../aether'
...
export interface StageBoundsInput {
  width?: number
  height?: number
  depth?: number
}
...
export class StageBoundsManager {
  constructor(
    private readonly bounds: StageBounds,
    private readonly physicsPostProcessor: PhysicsPostProcessor,
  ) {}
