...
/** Un frame de telemetría de audio. */
...
export class ShadowLogger {
  private readonly _log: ShadowFrame[] = [];
  ...
  private _dump(): void {
    ...
    try {
      ...
      console.log(
        `[SHADOW LOGGER] 🎯 DUMP COMPLETE: ${MAX_SHADOW_FRAMES} frames → ${dumpPath}`
      );
    } catch (e) {
