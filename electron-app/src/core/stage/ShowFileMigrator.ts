  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    apply: (show) => {
      ...
      for (const f of fixtures) {
        ...
        if (type !== 'moving-head' || orientation !== 'ceiling') continue

        const rotation = f.rotation as Record<string, unknown> | undefined
        if (!rotation || typeof rotation !== 'object') continue
