...
const _hexCacheHex: string[] = ['#000000', '#000000', '#000000', '#000000']

/** WAVE 7710: Zero-alloc HSL(0-1) → '#RRGGBB' with packed-RGB cache. */
function hslToHexCached(slot: number, h: number, s: number, l: number): string {
  ...
  if (packed === _hexCachePacked[slot]) return _hexCacheHex[slot]
...
const _colorPaletteScratch: ColorPalette = {
  primary:   { h: 0, s: 0, l: 0 },
 ...
 */
export function selenePaletteToColorPaletteMutate(selene: SelenePalette): ColorPalette {
 ...
 */
export function applyConsciousnessColorDecisionMutate(
 ...
 */
export function applyConsciousnessPhysicsModifierMutate(
