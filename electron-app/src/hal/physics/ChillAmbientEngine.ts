...
export interface ChillAmbientFrame {
  /** Front L — intensidad en [0.15, 0.45] */
  readonly frontL: number
  /** Front R — intensidad en [0.15, 0.45] */
  readonly frontR: number
  /** Back L (Mid Synths) — intensidad en [0.15, 0.45] */
  readonly backL: number
  /** Back R (Percussion) — intensidad en [0.15, 0.45] */
  readonly backR: number
  /** Mover L — intensidad en [0.15, 0.45] */
  readonly moverL: number
  /** Mover R — intensidad en [0.15, 0.45] */
  readonly moverR: number
  /** morphFactor para LiquidEngine71.morphFactorOverride — en [0.30, 0.70] */
 ...
 */
function dualSine(tSec: number, p1: number, p2: number, phaseOffset: number): number {
 ...
 */
function toRange(normalized: number): number {
