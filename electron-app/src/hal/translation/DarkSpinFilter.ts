...
interface DarkSpinState {
  /** Último color wheel DMX aplicado (ya estable, ANTES del tránsito activo) */
  lastStableColorDmx: number
  /** El nuevo color que fue ordenado y que está en tránsito ahora */
  pendingColorDmx: number
  /** ¿Está en tránsito ahora? */
  inTransit: boolean
