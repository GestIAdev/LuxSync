...
import { getColorTranslator, type RGB } from './ColorTranslator'
...
export function translateColor(
  ...
  /** Final RGB to use (may be different if translated) */
  rgb: RGB
  /** DMX value for color wheel (only for wheel fixtures) */
  colorWheelDmx: number
  /** Name of selected color (only for wheel fixtures) */
  colorName: string | undefined
  /** Was the color translated (true) or passed through (false)? */
  ...
  const safetyResult = safety.filter(
    fixtureId,
