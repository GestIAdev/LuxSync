...
// ═══════════════════════════════════════════════════════════════════════════
// HSL COLOR — El idioma nativo de Selene
// ═══════════════════════════════════════════════════════════════════════════

/**
 * Color en espacio HSL (Hue, Saturation, Lightness)
 * 
 * Rangos:
 *   h: 0-360 (grados en el círculo cromático)
 *   s: 0-100 (porcentaje de saturación)
 *   l: 0-100 (porcentaje de luminosidad)
 */
...
// ═══════════════════════════════════════════════════════════════════════════
// RGB COLOR — El idioma de salida
// ═══════════════════════════════════════════════════════════════════════════

/**
 * Color en espacio RGB (Red, Green, Blue)
 * 
 * Rangos: 0-255 por canal (8-bit)
 */
